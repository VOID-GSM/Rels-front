                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  {isAuthor && (
                    <div className="flex items-center gap-2 shrink-0">
                      <Link href={`/notification/${notice.id}/edit`}>
                        <button className="text-xs text-gray-500 border border-gray-300 rounded-md px-3 py-1 hover:bg-gray-50 transition-colors">
                          수정
                        </button>
                      </Link>
                      <button
